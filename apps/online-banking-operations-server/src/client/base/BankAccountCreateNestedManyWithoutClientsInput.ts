...
@InputType()
class BankAccountCreateNestedManyWithoutClientsInput {
...
export { BankAccountCreateNestedManyWithoutClientsInput as BankAccountCreateNestedManyWithoutClientsInput };
